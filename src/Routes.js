                                ...
                                <AdminUsersContextProvider>
                                    <BrowserRouter>
                                        <Switch>
                                            ...
                                            {/* Конец кода Михаила */}
                                            <PrivateRoute exact path="/admin-panel-news" component={AdminPanelNews} />
                                            <PrivateRoute exact path="/edit-materials" component={EditMaterials} />
                                            <PrivateRoute exact path="/add-event" component={AddEvent} />
                                            <PrivateRoute exact path="/edit-news/:id" component={EditNews} />
                                            <Route exact path="/favourite-news" component={FavouriteNews} />
                                            <PrivateRoute exact path="/edit-users" component={EditUsers} />
                                            <Redirect to="/" />
                                        </Switch>
                                        <Footer />
                                    </BrowserRouter>
